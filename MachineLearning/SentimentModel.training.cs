...
namespace MachineLearning
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\christopher.jamil\RiderProjects\Machine-Learning-.NET\MachineLearning\YelpReviewData.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"col0",outputColumnName:@"col0")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.03125F,L2Regularization=0.3899612F,LabelColumnName=@"col1",FeatureColumnName=@"Features"}))      
